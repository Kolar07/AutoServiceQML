...
ServiceTiming::ServiceTiming(int _mileage, int _interval_km, const QDate &_interval_time, const QString &_service, const QString &_type, const QString _timing)
: MaintenanceService(_mileage,_interval_km,_interval_time,_service,_type), timing(_timing){}
