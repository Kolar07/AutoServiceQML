...
public:
    ...
    ServiceOil(int _mileage,int _interval_km,QString date,  QString _interval_time, const QString &_service, const QString &_type, const QString _oil, const QString _oilFilter, QString _airFilter, const QString _cabinFilter);
